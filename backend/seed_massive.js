...
const realBusinesses = [
    ...
    // --- AVIATION (10) ---
    { name: 'Air Peace', category: 'Aviation', location: 'Ikeja, Lagos' },
    { name: 'Ibom Air', category: 'Aviation', location: 'Uyo, Akwa Ibom' },
    { name: 'Arik Air', category: 'Aviation', location: 'Ikeja, Lagos' },
    { name: 'Dana Air', category: 'Aviation', location: 'Ikeja, Lagos' },
    { name: 'Max Air', category: 'Aviation', location: 'Kano, Kano' },
    { name: 'Green Africa', category: 'Aviation', location: 'Ikeja, Lagos' },
    { name: 'Overland Airways', category: 'Aviation', location: 'Ikeja, Lagos' },
    { name: 'ValueJet', category: 'Aviation', location: 'Ikeja, Lagos' },
    { name: 'United Nigeria', category: 'Aviation', location: 'Enugu, Enugu' },
    { name: 'Aero Contractors', category: 'Aviation', location: 'Ikeja, Lagos' },
    ...
    { name: 'KPMG Nigeria', category: 'Consulting', location: 'Victoria Island, Lagos' },
    { name: 'PwC Nigeria', category: 'Consulting', location: 'Victoria Island, Lagos' },
    { name: 'Deloitte Nigeria', category: 'Consulting', location: 'Victoria Island, Lagos' },
    { name: 'EY Nigeria', category: 'Consulting', location: 'Victoria Island, Lagos' },
    { name: 'McKinsey & Company', category: 'Consulting', location: 'Ikoyi, Lagos' },
    { name: 'Boston Consulting Group', category: 'Consulting', location: 'Ikoyi, Lagos' },
    { name: 'Accenture Nigeria', category: 'Consulting', location: 'Victoria Island, Lagos' },
    { name: 'Phillips Consulting', category: 'Consulting', location: 'Lagos Island, Lagos' },
    { name: 'Verraki Partners', category: 'Consulting', location: 'Victoria Island, Lagos' },
    { name: 'Andersen Nigeria', category: 'Consulting', location: 'Ikoyi, Lagos' },

    // --- FASHION & LIFESTYLE (20) ---
    { name: 'Mai Atafo', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'Lisa Folawiyo', category: 'Fashion & Lifestyle', location: 'Ikoyi, Lagos' },
    { name: 'Dye Lab', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Orange Culture', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'Deola Sagoe', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Tiffany Amber', category: 'Fashion & Lifestyle', location: 'Ikoyi, Lagos' },
    { name: 'Kenneth Ize', category: 'Fashion & Lifestyle', location: 'Lagos Island, Lagos' },
    { name: 'Maki Oh', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'Ugo Monye', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'Banke Kuku', category: 'Fashion & Lifestyle', location: 'Ikoyi, Lagos' },
    { name: 'Andrea Iyamah', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Lanre Da Silva', category: 'Fashion & Lifestyle', location: 'Ikoyi, Lagos' },
    { name: 'Atafo', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'Odio Mimonet', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Ituen Basi', category: 'Fashion & Lifestyle', location: 'Ikeja, Lagos' },
    { name: 'Ejiro Amos Tafiri', category: 'Fashion & Lifestyle', location: 'Ikeja, Lagos' },
    { name: 'Tubo', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Matopeda', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'Style Temple', category: 'Fashion & Lifestyle', location: 'Wuse, Abuja' },
    { name: 'Hudayya', category: 'Fashion & Lifestyle', location: 'Wuse 2, Abuja' },
    ...
    { name: 'Dangote Cement', category: 'Manufacturing', location: 'Ikoyi, Lagos' },
    { name: 'Lafarge Africa', category: 'Manufacturing', location: 'Ikoyi, Lagos' },
    { name: 'Nestle Nigeria', category: 'Manufacturing', location: 'Ilupeju, Lagos' },
    { name: 'Unilever', category: 'Manufacturing', location: 'Oregun, Lagos' },
    { name: 'PZ Cussons', category: 'Manufacturing', location: 'Ilupeju, Lagos' },
    { name: 'Nigerian Breweries', category: 'Manufacturing', location: 'Iganmu, Lagos' },
    { name: 'Guinness Nigeria', category: 'Manufacturing', location: 'Ikeja, Lagos' },
    { name: 'Julius Berger', category: 'Manufacturing', location: 'Utako, Abuja' },
    { name: 'Reynolds Construction', category: 'Manufacturing', location: 'Jabi, Abuja' },
    { name: 'Hitech', category: 'Manufacturing', location: 'Victoria Island, Lagos' },
    { name: 'Seven-Up', category: 'Manufacturing', location: 'Ijora, Lagos' },
    { name: 'Coca-Cola Hellenic', category: 'Manufacturing', location: 'Ebute Metta, Lagos' },
    { name: 'Promasidor', category: 'Manufacturing', location: 'Isolo, Lagos' },
    { name: 'Honeywell Flour', category: 'Manufacturing', location: 'Apapa, Lagos' },
    { name: 'BUA Group', category: 'Manufacturing', location: 'Victoria Island, Lagos' },

    // --- MARKETING & ADVERTISING (15) ---
    { name: 'X3M Ideas', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'Insight Publicis', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'Noah\'s Ark', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'DDB Lagos', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'STB-McCann', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'Centrespread', category: 'Marketing & Advertising', location: 'Ilupeju, Lagos' },
    { name: '7even Interactive', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'Verdant Zeal', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'SO&U', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'Prima Garnet', category: 'Marketing & Advertising', location: 'Ilupeju, Lagos' },
    { name: 'Rosabel', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'Yellow Brick Road', category: 'Marketing & Advertising', location: 'Lekki, Lagos' },
    { name: 'Anakle', category: 'Marketing & Advertising', location: 'Lekki, Lagos' },
    { name: 'BrandEye', category: 'Marketing & Advertising', location: 'Ikeja, Lagos' },
    { name: 'Wildflower', category: 'Marketing & Advertising', location: 'Lekki, Lagos' },
    ...
    // --- BEAUTY & SPA (15) ---
    { name: 'House of Tara', category: 'Beauty & Spa', location: 'Lekki, Lagos' },
    { name: 'BMPro', category: 'Beauty & Spa', location: 'Ikoyi, Lagos' },
    { name: 'Zaron', category: 'Beauty & Spa', location: 'Ikeja, Lagos' },
    { name: 'Hegai & Esther', category: 'Beauty & Spa', location: 'Ikeja, Lagos' },
    { name: 'Yanga Beauty', category: 'Beauty & Spa', location: 'Lekki, Lagos' },
    { name: 'Nuban Beauty', category: 'Beauty & Spa', location: 'Lagos, Lagos' },
    { name: 'Gazelle', category: 'Beauty & Spa', location: 'Lekki, Lagos' },
    { name: 'Belfiore', category: 'Beauty & Spa', location: 'Lekki, Lagos' },
    { name: 'Venivici', category: 'Beauty & Spa', location: 'Lekki, Lagos' },
    { name: 'Apples & Oranges', category: 'Beauty & Spa', location: 'Victoria Island, Lagos' },
    { name: 'Oriki', category: 'Beauty & Spa', location: 'Victoria Island, Lagos' },
    { name: 'Laserderm', category: 'Beauty & Spa', location: 'Victoria Island, Lagos' },
    { name: 'Clear Essence', category: 'Beauty & Spa', location: 'Ikoyi, Lagos' },
    { name: 'B-Natural', category: 'Beauty & Spa', location: 'Victoria Island, Lagos' },
    { name: 'Montaigne Place', category: 'Beauty & Spa', location: 'Victoria Island, Lagos' },

    // --- RETAIL & FASHION (15) ---
    { name: 'Polo Avenue', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Temple Muse', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Alara', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Zashadu', category: 'Fashion & Lifestyle', location: 'Ikoyi, Lagos' },
    { name: '360 Creative Hub', category: 'Fashion & Lifestyle', location: 'Surulere, Lagos' },
    { name: 'Fashpa', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'Grey Velvet', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'L\'Espace', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Meidei', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: 'Zazaii', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Elanred', category: 'Fashion & Lifestyle', location: 'Lekki, Lagos' },
    { name: '41 Luxe', category: 'Fashion & Lifestyle', location: 'Wuse, Abuja' },
    { name: 'Garment Care', category: 'Fashion & Lifestyle', location: 'Victoria Island, Lagos' },
    { name: 'Soo\'s Place', category: 'Fashion & Lifestyle', location: 'Surulere, Lagos' },
    { name: 'Ruff \'n\' Tumble', category: 'Fashion & Lifestyle', location: 'Ikeja, Lagos' },

    // --- FITNESS (10) ---
    { name: 'I-Fitness', category: 'Fitness', location: 'Lekki, Lagos' },
    { name: 'Profit', category: 'Fitness', location: 'Ikeja, Lagos' },
    { name: 'Bodyline', category: 'Fitness', location: 'Ikoyi, Lagos' },
    { name: 'K-Fitness', category: 'Fitness', location: 'Victoria Island, Lagos' },
    { name: 'Lotus Fitness', category: 'Fitness', location: 'Victoria Island, Lagos' },
    { name: 'Pure grit', category: 'Fitness', location: 'Lekki, Lagos' },
    { name: 'Fit Nigeria', category: 'Fitness', location: 'Lekki, Lagos' },
    { name: 'Zumba with Ezinne', category: 'Fitness', location: 'Lekki, Lagos' },
    { name: 'Adna Barnet', category: 'Fitness', location: 'Ikeja, Lagos' },
    { name: 'Skyfit', category: 'Fitness', location: 'Lekki, Lagos' },

    // --- COWORKING (5) ---
    { name: 'Workstation', category: 'Coworking', location: 'Victoria Island, Lagos' },
