...
import { ShieldCheck, ArrowRight, User, Mail, Lock, Loader2, AlertCircle, CheckCircle } from 'lucide-react';
            ...
            <div className="auth-card signup-card">
                ...
                <form className="auth-form" onSubmit={handleSignup}>
                    ...
                    <div className="form-group">
                        ...
                        <input name="password" type="password" placeholder="Create a password" required minLength="6" disabled={isLoading} />
                    </div>
